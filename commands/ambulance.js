...
module.exports.run = async (client, message, args) => {
    ...
    const categoryID = "751462086319800361";
    ...
    var reportEmbed = new discord.MessageEmbed()
        ...
        .setFooter("Je sollicitatie voor **Ambulance** is aangemaakt!");
        ...
        (createdChannel) => {
            createdChannel.setParent(categoryID).then(
                (settedParent) => {
                    ...
                    settedParent.updateOverwrite(message.guild.roles.cache.find(x => x.name === '👑👑 | Hoofd-Ambulance'), {
                        CREATE_INSTANT_INVITE: false,
                        READ_MESSAGES: true,
                        SEND_MESSAGES: true,
                        ATTACH_FILES: true,
                    ...
                    settedParent.updateOverwrite(message.guild.roles.cache.find(x => x.name === '👑 | M+ Ambulancezorg'), {
                        CREATE_INSTANT_INVITE: false,
                        READ_MESSAGES: true,
                        SEND_MESSAGES: true,
                        ATTACH_FILES: true,
