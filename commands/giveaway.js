...
module.exports.run = async (client, message, args) => {
    ...
    //!giveaway aantalSpeler tijd berichtTekst
    ...
    setTimeout(function () {
        ...
        if (peopleReacted.length == 0) {
            return message.channel.send("De bot heeft gewonnen want niemand deed mee");
        }
        ...
        for (let y = 0; y < winners.length; y++) {
            ...
            message.channel.send("Gefeliciteerd: " + winners[y].username + `Je hebt dit gewonnen (${item})`)
...
module.exports.help = {
    name: "giveaway",
    description: "Geeft al de verschillende commandos",
    category: "Informatie"
}